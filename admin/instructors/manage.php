...
<html lang="fr">
    <head>
        <title>Gestion des animateurs - Fit&Fun</title>
        <meta charset="UTF-8">
    ...
    <body class="bg-light">
        ...
        <div class="container my-5">
            ...
            <?php if (isset($_GET['success'])): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <?php
                    switch($_GET['success']) {
                        case 'added': echo 'Animateur ajouté avec succès !'; break;
                        case 'updated': echo 'Animateur modifié avec succès !'; break;
                        case 'deleted': echo 'Animateur supprimé avec succès !'; break;
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="7" class="text-center py-5 text-muted">
                                                    ...
                                                    <p class="mt-3">Aucun animateur enregistré</p>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="bi bi-person-plus-fill me-2"></i>Ajouter un animateur</h5>
        ...
        <div class="modal fade" id="editInstructorModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="bi bi-pencil me-2"></i>Modifier l'animateur</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
        ...
        function setDeleteId(id, name) {
            document.getElementById('delete_instructor_id').value = id;
